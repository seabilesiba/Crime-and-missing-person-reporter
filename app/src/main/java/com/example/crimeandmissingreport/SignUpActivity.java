...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void setListener() {
        binding.txtHaveAccount.setOnClickListener(view -> startActivity(new Intent(SignUpActivity.this, SignInActivity.class)));
    ...
    private void signUp(){
        ...
        auth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                UserData userData = new UserData(downloadUrl, surname,location,name, email, phone, pass);

                reference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(userData).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
