...
public class FirstMissingAdapter extends RecyclerView.Adapter<FirstMissingAdapter.ViewHolder> {
    private List<MissingData> list;
    private Context context;

    public FirstMissingAdapter(List<MissingData> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.first_missing,
                parent,false);
        return new FirstMissingAdapter.ViewHolder(view);
    }
